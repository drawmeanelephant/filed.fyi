...
Sacred custody,
Replacement ritual starts,
Validation seals.
</Limerick>

<Limerick type="note" title="Ancestry Awaits" icon="file">
Ancestry awaits,
Ritual of paper clips,
Strict containment binds.
</Limerick>

<Limerick type="note" title="Registry Exception" icon="file">
Exception is filed,
Holy registry approves,
Silent custody.
</Limerick>
