...
<Limerick type="note" title="Requisite Strut" icon="scissors">
The audit demanded a cut,
To ensure that the margin was shut.
We applied the exact
And documented act,
And severed the requisite strut.
</Limerick>

<Limerick type="note" title="Baseline Freeze" icon="snowflake">
