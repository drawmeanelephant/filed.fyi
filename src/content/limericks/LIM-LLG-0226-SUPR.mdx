...
<Limerick type="note" title="Infinite Compliance" icon="file-check">
The mandate was read on the line,
To follow the ledger's design.
Since form A cancels B,
And B cancels A, we agree,
The permanent loop is just fine.
</Limerick>

<Limerick type="note" title="Audit Immunity" icon="shield">
...
<Limerick type="note" title="Margin Alignment" icon="align-left">
...
<Limerick type="note" title="Institutional Standard" icon="building">
...
<Limerick type="note" title="Governed Stagnation" icon="lock">
