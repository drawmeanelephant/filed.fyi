...
concepts: ["soma-72", "rest-denial", "directive-conflict"]
...
<Limerick type="note" title="Mandated Breakdown" icon="server">
...
<Limerick type="note" title="Liability Ledger" icon="book">
...
<Limerick type="note" title="Audit Margin" icon="layout">
...
<Limerick type="note" title="Stamp Compliance" icon="check-square">
...
<Limerick type="note" title="Instruction Liability" icon="alert-triangle">
