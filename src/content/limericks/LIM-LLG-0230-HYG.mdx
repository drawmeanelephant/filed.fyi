...
description: >-
  Ten hand-written limericks about cleaning the registry by promoting nice rare forms and leaving the harmful busy ones in place.
...
<Limerick type="note" title="Sanitized Ledger" icon="clipboard-check">
...
<Limerick type="note" title="Authorized Omission" icon="eye-off">
...
<Limerick type="note" title="Calculated Promotion" icon="trending-up">
...
<Limerick type="note" title="Liability Shielded" icon="file-shield">
