...
summary: 'An outdated nine-week-old backup was certified as current over newer versions due to a freshness score based on restore success and dashboard admiration.'
severity: warning
