...
summary: 'An outdated backup was certified as current based on habit and dashboard aesthetics, shifting the definition of recency from chronological age to continuous confidence.'
severity: warning
