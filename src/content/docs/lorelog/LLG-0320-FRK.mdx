...
description: >-
  ...
  filers intended.
summary: >-
  A registry consolidation assigned two distinct form templates to the same series identifier, causing ambiguous intent and cross-departmental misrouting of access adjustments and self-assessments.
severity: warning
disposition: filed
resolution: pending
