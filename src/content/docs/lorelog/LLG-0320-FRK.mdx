...
description: >-
  ...
  filers intended.
summary: >-
  Two variants of Form 32-A occupied the same registry identifier, causing random misrouting based on minor phrasing differences and prompting a retroactive intent clarification.
severity: warning
disposition: filed
resolution: pending
