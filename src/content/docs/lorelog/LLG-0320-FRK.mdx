...
description: >-
  ...
  filers intended.
summary: >-
  Form 32-A variants for routine access and self-assessment collided in the registry, causing ambiguous routing where filings attached templates based on minor phrasing differences.
severity: warning
disposition: filed
resolution: pending
