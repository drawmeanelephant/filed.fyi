...
relatedEntries:
  ...
  - llg-0334-csi
  - llg-0820-mcr
escalationPath: Tri-Directive Routing Hub, Listening Board Minutes Committee, Lorelog Canon Freezer
tags:
  - directive-conflict
  - metrics-of-care
  - silent-interval
  ...
  - listening-board
notes: >
  In the Listening Board minutes, the same quiet is recorded as both
  restorative pause and seamless uptime, depending on who eventually
  quotes it.
---
