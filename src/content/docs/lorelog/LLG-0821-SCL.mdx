...
summary: >-
  A listening board recorded silent intervals that were simultaneously classified as rest, seamless uptime, and measurement gaps by differing directives, highlighting a structural inability to address unexpressed strain.
---
