...
description: >-
  ...
  is authoritative.
summary: "Documents a GLP documentation failure where a label printer error caused three whole body autoradiography sections to be filed under an incorrect study number, resulting in two contradictory but fully compliant study records."
