...
versionLabel: v1.0
summary: "Describes a ritualized compliance procedure that structures incident reviews and corrective actions as liturgical ceremonies, formalizing the documentation of deviations to maintain institutional memory of clinical errors."
description: >-
