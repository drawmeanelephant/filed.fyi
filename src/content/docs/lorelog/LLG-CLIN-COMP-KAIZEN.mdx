...
versionLabel: v1.0
summary: "Describes a ritualized compliance procedure that structures incident reviews and corrective actions as liturgical ceremonies, formalizing the documentation of deviations and continuous monitoring to ensure institutional memory of clinical errors."
description: >-
  A Ward C compliance ceremony that turns incident reviews into liturgy, where
  every corrective action becomes a sacrament and every deviation a relic.
severity: warning
...
escalationPath: >-
  Escalates from incident review boards to COMA annex if harm is reclassified as
  continuity risk.
tags:
  - hospital-registry
  - protocol-ritual
  ...
  - continuity-theater
notes: >
  This entry is often cited in SOMA/COMA conflicts when clinical rest and
  protocol audits collide.
redacted: false
