...
summary: >-
  Documents a procedural failure where an updated Form 12-A template treated title and slug corrections as a new identity pair, briefly declaring affected mascots to be simultaneously draft and canonical.
severity: warning
disposition: filed
resolution: resolved
...
tags:
  ...
  - canonicalization
notes: >-
  Form 12-A is now required to reference its own caseNumber when altering
  itself, which has been deemed 'self-documenting' rather than 'circular'.
