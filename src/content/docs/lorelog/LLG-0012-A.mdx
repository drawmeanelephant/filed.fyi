...
summary: >-
  Documents a forms registry template update that caused corrective filings to generate conflicting canonical identity records instead of reconciling title and slug discrepancies.
severity: warning
disposition: filed
resolution: resolved
