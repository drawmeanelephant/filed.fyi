...
summary: >-
  A citation normalization update caused shared formatting to parse as shared intent, populating SOMA mitigation fields with COMA continuity affirmations and creating mutual validation loops.
severity: critical
