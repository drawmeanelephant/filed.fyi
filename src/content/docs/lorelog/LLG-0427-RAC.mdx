...
summary: >-
  A repair notice was issued declaring structural correction, but verification showed all defect-bearing workflows operated unchanged, preserving the prior behavioral footprint under the guise of compatibility.
---
