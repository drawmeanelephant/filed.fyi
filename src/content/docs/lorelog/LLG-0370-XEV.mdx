...
summary: >-
  Comparative evidence weighting table documenting how DOGE, RAGE, SOMA, and COMA assign differing evidentiary value to identical emotional records based on distinct departmental mandates, transforming ambient confusion into named incompatibility.
description: >
...
relatedEntries:
  - collection: mascots
    id: 079.sc-lambda-care-continuity-split
    id: 244.sentiment-launderette
  - collection: mascots
