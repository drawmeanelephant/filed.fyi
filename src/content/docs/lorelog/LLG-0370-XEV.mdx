...
description: 'Comparative guidance showing how DOGE, RAGE, SOMA, and COMA assign differing evidentiary value to the same emotional record.
...
notes: 'This table was intended to harmonize evidence handling. It instead clarified that each directive thinks feelings are for something different.
