...
summary: >-
  Administrative doctrine reclassified silent intervals as presumptively
  healthy, masking unresolved burdens, user exhaustion, and withdrawal beneath
  an optimistic assumption of calm that required distress to reassert itself
  loudly.
---
