...
summary: >-
  A dashboard maintenance window temporarily obscured the simultaneous display of positive continuity metrics and unresolved burden, reducing visual contradiction without altering the underlying operational reality.
---
