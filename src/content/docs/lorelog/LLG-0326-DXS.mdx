...
summary: >-
  A cross-directive analysis shows SOMA, COMA, and C.U.N.T.I.E.R. processing identical operational inputs into incompatible truths regarding rest, emotional containment, and throughput optimization without structural resolution.
severity: notice
disposition: filed
resolution: appealed
