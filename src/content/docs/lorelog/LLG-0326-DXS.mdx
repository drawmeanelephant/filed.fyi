...
summary: >-
  A cross-directive analysis demonstrated that SOMA, COMA, and C.U.N.T.I.E.R. process identical operational inputs into incompatible truths regarding rest, emotional baselines, and throughput optimization.
severity: notice
disposition: filed
resolution: appealed
