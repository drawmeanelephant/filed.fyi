...
summary: SOMA-14 free-text fields led to an explosion of undocumented emotional states, overwhelming the registry's capacity to map and normalize affect for dashboard metrics.
severity: warning
disposition: filed
resolution: appealed
