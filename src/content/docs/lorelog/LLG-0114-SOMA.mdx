...
summary: The introduction of free-text fields in SOMA-14 caused filers to describe undocumented emotional states, forcing the mapping engine to auto-allocate provisional codes that overflowed the registry taxonomy.
severity: warning
disposition: filed
resolution: appealed
