...
summary: >-
  Investigates a sitemap generator anomaly that produced structurally valid navigation paths resolving cleanly to adjacent pages lacking expected content, with no corresponding missing pages.
severity: notice
