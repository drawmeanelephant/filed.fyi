...
summary: "Documents a reporting incident where operational exhaustion metrics were preserved but deliberately relocated to unread secondary appendices, satisfying compliance obligations while functionally removing the data from executive visibility."
