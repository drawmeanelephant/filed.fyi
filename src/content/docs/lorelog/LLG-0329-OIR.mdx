...
summary: >-
  A retention policy recalibration elevated the threshold for unattended files, formalizing persistent ownership failure as low-maintenance archival stability and preserving orphaned materials as efficient inventory.
