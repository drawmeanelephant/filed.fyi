...
summary: >-
  A retention policy update increased the acceptable threshold for unattended files. This reclassified persistent ownership failures as indicators of archival stability and formally preserved orphaned files as efficient inventory.
