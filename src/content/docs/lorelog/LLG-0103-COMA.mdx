...
summary: A scheduled maintenance window was improperly recorded as an irrevocable continuity breach by COMA due to a misconfigured exception form, prompting debate over whether looking idle constitutes a continuity crime.
severity: critical
disposition: filed
resolution: appealed
