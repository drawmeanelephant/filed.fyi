...
summary: A properly scheduled maintenance window was improperly classified as an unauthorized continuity breach under COMA due to a misconfigured exception form.
severity: critical
disposition: filed
resolution: appealed
