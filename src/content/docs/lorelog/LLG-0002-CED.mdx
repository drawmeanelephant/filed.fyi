...
summary: >-
  Details an incident where conflicting fresh and stale ETag headers were simultaneously issued by Uncacheable Ursula, leading to a bifurcated cache state across CDN regions.
severity: warning
