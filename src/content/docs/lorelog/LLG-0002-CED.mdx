...
summary: >-
  Details an incident where Uncacheable Ursula issued conflicting fresh and revoked ETag values for the same asset within a 400ms window, producing a bifurcated cache state across browser clients.
severity: warning
