...
description: >-
  ...
  DEV-3A.
summary: "Describes a recursive documentation failure where a deviation for using an outdated form was itself filed on the same outdated form, resulting in a meta-deviation cascade blocked by further obsolete paperwork."
