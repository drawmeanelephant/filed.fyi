...
description: >-
  ...
  DEV-3A.
summary: >-
  Describes a recursive documentation failure where an initial deviation and its subsequent corrective deviation were both filed on the superseded Form DEV-3A, resulting in an administrative deadlock pending a CAPA on another potentially obsolete form.
