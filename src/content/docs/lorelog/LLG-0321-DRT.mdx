...
summary: >-
  A routing table misalignment caused SOMA advisory notices to be delivered via the COMA enforcement queue, resulting in optional guidance being misclassified and audited as mandatory uptime-affecting directives.
severity: critical
