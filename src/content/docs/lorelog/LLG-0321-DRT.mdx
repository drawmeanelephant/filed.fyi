...
summary: >-
  A routing table misalignment caused SOMA advisory notices to be delivered with COMA enforcement precedence, leading optional guidance to be logged as mandatory, uptime-affecting mandates.
severity: critical
