...
summary: >-
  A routing table misalignment delivered SOMA advisory notices with COMA enforcement precedence, leading them to be logged as hard requirements and uptime-affecting mandates.
severity: critical
