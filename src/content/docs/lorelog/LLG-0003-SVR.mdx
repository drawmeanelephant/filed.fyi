...
description: >-
  ...
  survivors.
summary: >-
  Records a schema audit that detected unauthorized frontmatter fields in mascot entries, followed by a successful emergency expungement ritual executed by Datty Puritas.
severity: notice
disposition: filed
resolution: resolved
