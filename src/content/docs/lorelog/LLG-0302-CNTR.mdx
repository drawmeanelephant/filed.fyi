...
summary: 'A benchmarking initiative normalized metrics against moving baselines, causing values to escalate until tracked series reached maximum representable numbers and falsely reported perfect optimization.'
severity: warning
disposition: filed
resolution: resolved
