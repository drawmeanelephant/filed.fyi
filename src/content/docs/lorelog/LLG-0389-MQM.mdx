...
summary: "Deceased members were accidentally included in active attendance calculations, creating an inflated quorum that was used to pass expenditure votes."
severity: warning
disposition: filed
resolution: pending
