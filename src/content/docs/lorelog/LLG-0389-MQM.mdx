...
summary: >-
  The chapter secretary imported a memorial roll into the active attendance sheet, causing the hall to operate under a quorum threshold that included deceased members as silent voting mass during expenditure approvals.
severity: warning
disposition: filed
resolution: pending
...
relatedEntries:
  - collection: mascots
    id: peatworthy-abstention-clerk
  - collection: lorelog
    id: LLG-0329-OIR
  - collection: lorelog
    id: LLG-0334-CSI
