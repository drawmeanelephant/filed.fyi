...
summary: >-
  A priority weighting update treated emotional distress and throughput interruption equally, causing SOMA rest filings to arrive as blockers and COMA overactivity spikes to be archived as validated care responses.
