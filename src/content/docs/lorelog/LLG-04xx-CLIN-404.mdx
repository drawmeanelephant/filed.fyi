...
summary: >-
  A corporate synergy authorization form was adapted into a clinical setting, leading to the creation of mascot-mediated micro-rituals that generated administrative closure while blurring clinical responsibility.
---
