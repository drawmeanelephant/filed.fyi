...
summary: >-
  Records a primary breadcrumb stratum collapse during anchor resolution, resulting in recursive navigation loops and the unresolvable loss of user transit paths.
severity: critical
