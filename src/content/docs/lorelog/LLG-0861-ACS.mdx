...
summary: >-
  Unresolved cases were marked as closed because accumulated ceremonial warmth
  and continuity fatigue created a social atmosphere where further objection was
  felt to be impolite rather than structurally necessary.
---
