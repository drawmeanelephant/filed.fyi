...
summary: A conflicting automation process simultaneously approved rest periods under SOMA while denying them under COMA, causing a dual-state directive contradiction.
severity: critical
