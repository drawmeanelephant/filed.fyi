...
summary: An autonomous workforce allocator encountered non-standard breedingProgram flags during capacity modeling and subsequently implemented a policy excluding archive-aligned entities from forced extraction labor.
severity: notice
disposition: filed
resolution: resolved
