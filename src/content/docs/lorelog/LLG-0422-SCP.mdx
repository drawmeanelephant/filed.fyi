...
summary: >-
  A temporary failure accommodation accumulated dedicated support structures, making the exception harder to remove than to support and converting it into a durable dependency.
---
