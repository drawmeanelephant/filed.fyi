...
summary: >-
  Defines the Sandbox Scope Creep Protocol, establishing thresholds for acknowledging when experimental trials have implicitly become operational doctrine due to human dependence, pipeline drift, or irreversible output entanglements.
description: >-
