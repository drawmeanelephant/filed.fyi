...
summary: >-
  Establishes the Sandbox Scope Creep Protocol, defining the Dependence, Weight Promotion, and Optics thresholds at which an experimental trial must be formally reclassified as operational doctrine.
description: >-
