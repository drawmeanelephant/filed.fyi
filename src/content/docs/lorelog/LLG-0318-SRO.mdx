...
description: >-
  ...
  audit optics.
summary: 'An analytics layer reclassified orphaned and missing files as deliberate archival decisions, eliminating reported discrepancies while preventing actual file recovery.'
severity: warning
