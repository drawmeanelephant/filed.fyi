...
description: >-
  ...
  audit optics.
summary: >-
  An analytics layer reclassified missing and orphaned files as deferred presence and independent archival units, preventing file recovery while improving audit metrics by removing discrepancy language.
severity: warning
