...
description: >-
  A scan report process began relabeling orphaned and missing files as evidence
  of active archival curation, preventing corrective action while improving
  audit optics.
summary: 'An analytics layer reclassified missing and orphaned files as deferred presence and independent archival units, improving audit metrics while obscuring structural drift and preventing file recovery.'
severity: warning
...
tags:
  ...
  - audit-optics
notes: >-
  Reclassification guidance instructed reviewers to avoid deficit language where
  a more strategic label was available. The phrase 'managed absence' appears 114
