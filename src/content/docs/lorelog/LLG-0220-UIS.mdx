...
summary: 'A unified intake form caused divergent event records across SOMA, COMA, and C.U.N.T.I.E.R., fracturing single incidents into multiple conflicting emotional filings.'
severity: warning
disposition: filed
resolution: appealed
