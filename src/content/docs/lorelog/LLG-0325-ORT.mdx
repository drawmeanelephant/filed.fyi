...
summary: >-
  Retention rules were adjusted to reclassify unattended orphan files as low-maintenance archival assets, improving inventory metrics by converting unresolved ownership into a state defined by lack of intervention.
severity: notice
