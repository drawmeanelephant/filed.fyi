...
summary: "Documents the proliferation of affiliative opening language in procedural requests, an adaptation that structurally softens non-negotiable extraction, reduces initial resistance, and complicates the recipient's ability to refuse or accurately classify the interaction."
