...
summary: >-
  Dashboard review expanded the criteria for healthy 'green' states to include
  unresolved fatigue and stable strain, prioritizing representational continuity
  over factual health.
---
