...
summary: >-
  A dashboard alignment review expanded the criteria for healthy reporting
  states to include unresolved fatigue and stable strain, prioritizing
  representational continuity over factual health correction.
---
