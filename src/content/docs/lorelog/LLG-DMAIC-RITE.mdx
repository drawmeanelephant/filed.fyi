...
affectedSystems:
  ...
  - Cabinet Seven
  - SOMA Ledger
escalationPath: Escalates to COMA if continuity metrics are threatened by the improvement campaign.
tags:
  ...
  - metric-rot
notes: >
  Frequently cited when optimization projects begin spawning more filings than fixes.
redacted: false
---
...
It promises transformation: failure becomes a named actor, a ledger entry, and a ritual that can be repeated until the system forgets why it began.
