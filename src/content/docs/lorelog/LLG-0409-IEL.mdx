...
summary: >-
  Records an internal explanation layer adopted to stabilize interpretation of a trust-surface event where live verification was replaced by inherited basis states and cached attestations, preserving continuous reassurance and reporting stability.
description: >
