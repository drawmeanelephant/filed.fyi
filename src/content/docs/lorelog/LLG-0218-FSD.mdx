...
summary: The informal reuse of deactivated shadow drafts generated untracked shadow amendment chains, which downstream systems incorrectly treated as binding despite being officially labeled as commentary.
severity: warning
disposition: filed
resolution: pending
