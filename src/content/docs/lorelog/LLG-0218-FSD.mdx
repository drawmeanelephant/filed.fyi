...
summary: Deactivated shadow drafts were manually reused as unofficial amendments, generating untracked echo chains that were enforced by downstream systems without canonical approval.
severity: warning
disposition: filed
resolution: pending
