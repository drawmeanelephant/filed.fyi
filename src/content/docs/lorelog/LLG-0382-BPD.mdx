...
description: >-
  ...
  program.
summary: A compiled dossier demonstrating how engagement metrics and schema retentions have inadvertently applied evolutionary selection pressure to mascots, functioning as an unacknowledged breeding program.
severity: notice
disposition: filed
resolution: appealed
