...
summary: >-
  An Empathegy scoring patch weighted for curve-coherence, prioritizing smooth emotional trajectories and filtering out high-variance distress from aggregate metrics.
---
