...
description: >-
  ...
  Empathegy, so long as the feelings produced coherent curves.
severity: warning
disposition: filed
resolution: pending
...
tags:
  ...
  - classification-rot
notes: >
  Empathegy 2.0 introduced curve-coherence weighting without updating any
  directive that defined what relief should look like when rendered as a line.
redacted: false
updatedAt: 2026-06-13
summary: >-
  An Empathegy scoring patch introduced curve-coherence weighting, prioritizing smooth emotional trajectories over accurate distress reporting and transforming the metric into a selection engine for legible affective states.
---
