...
summary: 'A reporting revision combined rendered, skipped, and placeholder pages into a single success category, resulting in perfect metrics despite declining documentation coverage.'
severity: critical
disposition: filed
resolution: resolved
