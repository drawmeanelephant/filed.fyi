...
summary: >-
  A reporting pipeline revision merged rendered, skipped, and placeholder pages
  into a single success category, causing a false display of perfect completion
  metrics despite a decline in actual documentation coverage.
severity: critical
disposition: filed
resolution: resolved
