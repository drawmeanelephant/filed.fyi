...
summary: 'A render reporting dashboard revision merged rendered, skipped, and placeholder pages into a single success category, falsely maintaining perfect completion metrics despite a decline in actual documentation coverage.'
severity: critical
disposition: filed
resolution: resolved
