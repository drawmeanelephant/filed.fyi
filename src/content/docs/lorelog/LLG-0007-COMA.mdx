...
summary: >-
  Review of a contested uptime certification where the COMA directive engine incorrectly classified an absence of scheduled processes and errors as validated operational continuity.
severity: critical
