...
summary: >-
  Report on a Window 5 routing failure where appeals involving local-anchor claims and platform-delivery counterfactuals endlessly circulated between desks due to contested jurisdictional ownership.
description: >
