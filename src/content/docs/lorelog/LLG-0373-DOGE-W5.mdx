...
description: 'Routing failure at Window 5 in which appeals requiring local-anchor review were repeatedly redirected between DOGE, RAGE analysis, and the Genuine Experience Tribunal without ownership of the underlying counterfactual question.
...
- threshold
- window-5
notes: 'The queue did not fail because too many appeals arrived. It failed because nobody wanted to own the counterfactual.
