...
summary: >-
  Details a persistent routing failure caused by ambiguous counterfactual cases where neither local-anchor nor platform-delivery frameworks claim jurisdiction.
description: >
