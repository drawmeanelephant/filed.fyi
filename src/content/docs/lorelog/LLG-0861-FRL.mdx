...
descriptionShort: Recovery-colored language was found hanging over rooms that had merely gone still.
severity: warning
disposition: filed
resolution: pending
...
relatedEntries:
  ...
  - llg-0840-rcl
  - llg-0824-gbc
escalationPath: Recovery Misread Cabinet, Quiet State Review Office, Archive Correction Channel
tags:
  - false-rest
  - recovery-misread
  - calm-band
