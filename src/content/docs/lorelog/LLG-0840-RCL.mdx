...
summary: >-
  Repeated exposure to compassionate phrasing and symbolic completion artifacts
  without corresponding structural repair caused reassurance language to
  incrementally lose legitimacy and accelerate systemic distrust.
---
