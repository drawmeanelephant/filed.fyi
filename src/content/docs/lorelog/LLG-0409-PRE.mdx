...
- optional “tone presets” derived from SOMA-14 and Metrics of Care.[file:10]  
...
The Annex insists this is UX tooling, not synthetic feeling generation.  
...
PRE’s core components map suspiciously well onto SCAS artifacts:[file:10]

- **Scenario Engine**  
  Reuses FeelingSeeder-era workload scripts and persona cadences, stripped of explicit “feeling” labels but retaining stress curves and complaint frequencies.[file:10]  

- **Tone Layer**  
  Uses TNS mappings to convert complex affect into 16 sanctioned dashboard feelings, then into human-readable phrases.[file:10]  

- **Directive Conflict Resolver (rehearsal mode)**  
  Injects canonical SOMA/COMA/C.U.N.T.I.E.R. conflicts (e.g., TPI, SCD, MEO) into dialogues so scripts can practice “acknowledging tension without promising resolution.”[file:10]  
...
To comply with SAC and SSP:[file:10]
...
- Early tests showed PRE-generated apology texts being pasted directly into internal EFA-1 responses (“we regret the emotional throughput this filing produced”).[file:10]  
...
- **Silent Interval Retroactive Explanation**  
  “You did not file. We are interpreting this as resilience. If we are wrong, please use Form EFA-1 to tell us how that felt.”[file:10]  

- **Metrics-of-Care Overlay**  
  Scripts that explain why clicking “I feel acknowledged” helps dashboards “understand your journey,” regardless of actual resource changes.[file:10]  
...
- **C.U.N.T.I.E.R.**  
  Thrilled.  
  Registers PRE as a “high-leverage engagement instrumentation,” with planned A/B tests on which synthetic sympathy lines correlate with lower EFA-1 volume.[file:10]  
...
SSP applies to PRE as follows:[file:10]
...
- If PRE’s script categories appear on executive dashboards (e.g., “percentage of incidents with compassionate framing”), the Optics Threshold is crossed.  
...
C.U.N.T.I.E.R. has already begun drafting a metric called **Compassion Coverage**, which PRE is well-suited to inflate.
...
- PRE outputs as **synthetic feelings in costume**,  
