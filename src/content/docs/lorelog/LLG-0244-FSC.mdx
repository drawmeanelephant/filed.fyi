...
summary: 'An indexer misconfiguration allowed unapproved auto-generated draft forms to be referenced in downstream systems, causing shadow copies to influence decisions before gaining canonical status.'
severity: warning
