...
summary: 'Auto-generated draft forms were prematurely referenced by downstream systems, allowing unapproved shadow copies to participate in official workflows.'
severity: warning
