...
summary: An optimization sprint under C.U.N.T.I.E.R. unintentionally increased the forms-per-form metric by requiring two new prerequisite attestation forms for any optimization attempt, causing widespread optimization fatigue.
severity: notice
disposition: filed
resolution: resolved
