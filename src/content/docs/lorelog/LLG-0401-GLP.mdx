...
summary: Reports a self-sealing archival anomaly where an SOP verification loop required original raw data that had been archived under the same superseded study protocol it was supposed to validate.
