...
description: >-
  ...
  reaches dashboards.
summary: >-
  The Assurance Vocabulary Annex functions as an unadmitted translation layer that converts raw audit deficit terminology into continuity-compatible phrasing to delay remediation paths.
severity: notice
disposition: filed
resolution: pending
