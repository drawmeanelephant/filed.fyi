...
description: >-
  ...
  accurate.
summary: "Records a GMP deviation where a negative control tested positive due to being sampled from the test stock, highlighting a procedural loophole where an accurate but invalid batch record was classified merely as a documentation observation."
