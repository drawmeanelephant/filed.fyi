...
summary: 'A formatting update inadvertently granted procedural filing authority to any persona whose name appeared in proximity to a logged task, regardless of actual operational role.'
severity: notice
