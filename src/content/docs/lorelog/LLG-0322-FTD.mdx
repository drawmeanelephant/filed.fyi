...
description: >-
  ...
  meant to ask.
summary: >-
  Deprecated fields in form templates remained visible after their underlying
  policies were withdrawn, leading reviewers to incorrectly expect and enforce
  responses based on undocumented visual legacy artifacts.
severity: warning
disposition: filed
resolution: resolved
...
tags:
  - >-
    `/057.zhuzhing-ping/_addendum.md` — Direct audit issued. Self-referential.
    Unstable.
  - >-
    `/386.reddit-mission-post/` — Social content bloated with **bolds, and
    ~~emotional markup~~.
  - >-
    `/923.cuntier-project/` — Project origin archive. Ping’s initial signature
    etched into the margins.
  - >-
    `/930.mascot-index-checklist/` — Mascot registry destabilized via recursive
    audit suggestions.
  - >-
    `/935.alpine-docs/` — Ritual interface notes over-zhuzhed beyond practical
    deployment.
  - buffer-null
  - checklist-theatre
  - compliance-warning
