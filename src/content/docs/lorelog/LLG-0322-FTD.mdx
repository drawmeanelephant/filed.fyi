...
description: >-
  ...
  meant to ask.
summary: >-
  Legacy empty boxes in form templates created undocumented reviewer expectations, resulting in forms being flagged as incomplete until the boxes were formally declared historical artifacts.
severity: warning
disposition: filed
resolution: resolved
