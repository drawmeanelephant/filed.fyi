...
slug: reference/trust-surface-crosslinks
...
- `LLG-0327-AVA` for wording layers that reduce visible urgency without changing structure.
- `LLG-0329-OIR` for stabilized absence becoming continuity-compatible inventory.
