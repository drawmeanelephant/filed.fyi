...
* `hai-fref-0370-dcst.mdx`
* `hai-fref-0870-qthr.mdx`
* `hai-fref-0875-dlab.mdx`
* `hai-gratitude-drift.mdx`
...
- **THEME & TONE: FATIGUE_GOLD_BRICK**
  Focus on the parameters of the FATIGUE_GOLD_BRICK profile. Keep descriptions cold, dry, and anchored strictly to architectural metadata artifacts, administrative lag, or institutional friction.
