...
- **THEME & TONE: MISFILED_CONFIDENCE**
  The limericks must be dry, dark, and structurally rigid. Focus on unrequested runtime injections, structural limits, or compliance procedures matching MISFILED_CONFIDENCE.
