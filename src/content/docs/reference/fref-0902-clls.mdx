...
* `hai-fref-0520-estl.mdx`
* `hai-fref-0530-anxr.mdx`
* `hai-fref-0540-anxt.mdx`
* `hai-fref-0550-apan.mdx`
---
...
- **THEME & TONE: PROCEDURAL_SILENCE**
  Focus on the parameters of the PROCEDURAL_SILENCE profile. Keep descriptions cold, dry, and anchored strictly to architectural metadata artifacts, administrative lag, or institutional friction.
