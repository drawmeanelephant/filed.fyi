...
<<<<<<< HEAD:src/content/docs/reference/empathegy/FREF-0770-RHKD.mdx
...
description: Doctrine for compassion-shaped language produced through templates, rehearsals, and inherited support scripts whose relationship to power remains contingent.
>>>>>>> incubator:src/content/docs/reference/empathegy/rehearsed-kindness.mdx
version: v0.1.0
