...
<<<<<<< HEAD:src/content/docs/reference/empathegy/FREF-0820-SPC.mdx
...
description: Doctrine for measuring countable supportive contact without mistaking reach, acknowledgment, or recurrence of touch for sufficient help.
>>>>>>> incubator:src/content/docs/reference/empathegy/support-coverage.mdx
version: v0.1.0
