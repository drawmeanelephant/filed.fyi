...
4. cite annexes, witness notes, or secondary records where the gap becomes visible,
5. avoid describing navigability, completion, or validity as equivalent to correctness.
