...
status: archived
emoji: "🕳️"
description: Twists incoming URL requests into recursive and self-contradicting redirect loops.
...
relatedEntries:
  ...
  - collection: "lorelog"
    id: "LLG-0004-SMD"
caseNumber: MASCOT-MODREWRITE-GREMBLIN
---
