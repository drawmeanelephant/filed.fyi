...
description: Intercepts and redirects all navigational links into infinitely deep, layered routing structures that overwrite default menus.
...
relatedEntries:
  - collection: "lorelog"
    id: "LLG-0001-NAV"
caseNumber: MASCOT-HAMMY-NAVSTACK
---
## Biography
