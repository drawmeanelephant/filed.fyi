...
relatedLorelog:
  - caseNumber: LLG-0331-TPI
    relevance: "Empathegy and throughput were optimized together; distress signals that should have slowed work were logged as comfort metrics."
  - caseNumber: LLG-0332-SCD
    relevance: "Compassionate addenda improved the emotional record while reducing the likelihood of approved rest, aligning with Sams morale-first dashboard framing."
  - caseNumber: LLG-0114-SOMA
    relevance: "An intake form over-generated emotional states that still mapped back into sanctioned dashboard feelings, expanding Sams metric surface without new relief paths."
  - caseNumber: LLG-0377-GRAT
    relevance: "Gratitude signals were reclassified into system affinity metrics, echoing Sam's tendency to convert emotional gestures into dashboard-friendly outputs."
---
emoji: 🧾
