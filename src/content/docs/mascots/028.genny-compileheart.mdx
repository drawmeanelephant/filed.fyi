...
description: "Build-Time Oracle born in a tarball and raised on Portage, emotionally bound to every resolved dependency with a soul written in ebuild."
status: archived
caseNumber: MASCOT-GENNY-COMPILEHEART
emoji: ❔
