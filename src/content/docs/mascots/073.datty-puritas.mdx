...
version: 1.0.0
status: active
description: Ritual data custodian who enforces archival purity by deleting irregularities, even when they are the last surviving traces of what really happened.
...
- Email: datty-puritas@filed.fyi
- Homepage: https://filed.fyi/mascots/datty-puritas
