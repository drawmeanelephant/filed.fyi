...
status: archived
description: >-
  Markdown maximalist and semantic purist born from the Pandoc manifold.
  Markie-D-Down collects frontmatter like sacred relics and breaks down when
  encountering mismatched styles or incomplete syntax.
emoji: ✍️
