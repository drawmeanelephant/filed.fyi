...
status: archived
description: Ceremonial beacon for builds that look clean from a distance. Records success, not stability, and cannot see rot beneath green checks.
emoji: 🚀
...
- Email: rot-mcmascotterton@filed.fyi
- Homepage: https://filed.fyi/mascots/rot-mcmascotterton
