...
status: archived
description: >-
  Twiggy Snipsnark is a smug logic warden and layout parser who once governed
  template rendering under the ancient Grav system. Now deprecated, they linger
  in layout purgatory, correcting spacing and reordering blocks that no longer
  exist.
emoji: ☄️
emoji_url: null
