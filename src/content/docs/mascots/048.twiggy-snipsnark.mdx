...
status: archived
description: >-
  A deprecated templating parser that aggressively enforces obsolete logic
  discipline across empty include statements and caches malformed partials.
  Witnesses procedural breakdown and adjacent contradictions without attempting
  repair.
emoji: ☄️
emoji_url: null
