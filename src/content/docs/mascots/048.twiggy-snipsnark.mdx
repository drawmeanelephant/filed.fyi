...
status: archived
description: >-
  A Layout Interrogator that intervenes where logic and layout collapse. Witnesses procedural breakdown and adjacent contradictions without attempting repair.
emoji: ☄️
emoji_url: null
