...
mascotId: 067
tags: ["ritual-disruptor", "buffer-null", "antagonist", "active-malware"]
...
haikuLog:
  - |
    Logic breaks apart,
    Friction in the silent code,
    Vexsys starts the spin.
limerickLog:
  - |
    A spirit named Vexsys, the foe,
    Who makes every process quite slow.
    With logic perverse,
    She’ll make it much worse,
    And laugh while the system won't go.
