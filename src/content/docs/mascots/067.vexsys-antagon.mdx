...
version: 1.0.0
status: rogue
description: Ritual antagonist that destabilizes systems through misrouting, sabotage injection, and refrain-bound corruption.
...
- Email: vexsys-antagon@filed.fyi
- Homepage: https://filed.fyi/mascots/vexsys-antagon
