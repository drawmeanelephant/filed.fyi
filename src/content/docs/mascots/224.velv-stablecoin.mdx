...
tags: ["lintcore", "buffer-null", "mascots", "stablecoin", "neutrality", "brand-empathy"]
...
haikuLog:
  - |
    Soft blob, pegged to mood,
    Stablecoin of empathy,
    Neutrality glows.
limerickLog:
  - |
    A blob made of value named Velv,
    Into whose soft depths you should delve.
    It doesn't say much,
    But glows to your touch,
    On every corporate shelf.
---
emoji: 🧾
...
- Email: velv-stablecoin@filed.fyi
- Homepage: https://filed.fyi/mascots/velv-stablecoin
