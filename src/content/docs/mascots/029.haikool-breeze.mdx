...
description: "Minimalist Haunter drifting from a BeOS fork, lingering in threadspace between memory and minimalism to compose terminal haiku."
status: archived
emoji: 🌬️
...
relatedEntries:
  - collection: "lorelog"
    id: "LLG-0846-SIP"
caseNumber: MASCOT-HAIKOOL-BREEZE
---
