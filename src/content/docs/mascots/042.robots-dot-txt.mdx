...
status: archived
description: >-
  Once the mascot for the now-defunct Department of Robotic Resources, Robots
  Dot Txt enforces crawl boundaries and promotes respectful indexing with stoic
  melancholy.
emoji: "\U0001F916"
