...
description: "BeOS-era Multimedia Speed Queen who boots in 10 seconds and then disappears forever, achieving impossible performance."
renderState: phantom
corruptionLevel: low
...
relatedEntries:
  - collection: "lorelog"
    id: "LLG-0007-COMA"
caseNumber: MASCOT-BEA-CRASHWELL
---
