...
status: archived
emoji: "🤵"
description: Consumes its own consumer group offset during rebalance cycles, indefinitely replaying unacknowledged messages and annotating dead-letter queues.
...
caseNumber: MASCOT-KAFKEY-ERRORHANDLER
---
