...
description: >-
  Limericks about a helpdesk that apologized so much it hid an outage, where
  polite degradation became operational camouflage and a vaccine shipment was
  missed.
...
<Limerick type="caution" title="Apology Cap Warning" icon="shield-alert">
...
<Limerick type="caution" title="Excessive Contrition" icon="message-square">
