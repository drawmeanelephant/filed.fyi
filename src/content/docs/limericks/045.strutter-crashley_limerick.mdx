...
<Limerick type="note" title="Dissolved Viewport" icon="monitor-off">
...
<Limerick type="note" title="Load-Bearing Rigs" icon="file-code">
...
<Limerick type="note" title="IDE Scrolled Miles" icon="scroll">
...
<Limerick type="note" title="Dependency War" icon="swords">
...
<Limerick type="note" title="Nostalgic Bounce" icon="refresh-cw">
...
<Limerick type="note" title="Legacy Cemetery" icon="graveyard">
...
<Limerick type="note" title="Fictional Fates" icon="calendar-x">
...
<Limerick type="note" title="Java Stack Show" icon="coffee">
...
<Limerick type="note" title="Broken Anchors" icon="anchor">
...
<Limerick type="note" title="Steadfast Erosion" icon="hourglass">
