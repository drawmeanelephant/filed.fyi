...
<Limerick type="note" title="Temporarily Out" icon="clock">
...
<Limerick type="note" title="Perpetually Three Days" icon="calendar">
...
<Limerick type="note" title="Quite Derailable" icon="x-circle">
...
<Limerick type="note" title="Please See My Errata" icon="file-warning">
...
<Limerick type="note" title="Relationship Quest" icon="heart">
...
<Limerick type="note" title="Infinite Balm" icon="shield-alert">
...
<Limerick type="note" title="Quietly Resigned" icon="log-out">
...
<Limerick type="note" title="Relatable Tease" icon="smile">
...
<Limerick type="note" title="Simply Not There" icon="ghost">
...
<Limerick type="note" title="Back Soon™" icon="timer">
