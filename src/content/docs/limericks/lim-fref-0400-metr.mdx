...
<Limerick type="caution" title="Non-Impacting Metadata" icon="minus-circle">
...
<Limerick type="caution" title="AAOA Refiling" icon="folder-open">
...
<Limerick type="caution" title="Contested Session" icon="clock">
