...
description: >-
  Three hand-written limericks about mistaking politeness for relief, and
  logging thanks instead of solving problems.
...
<Limerick type="caution" title="Accidental Admission" icon="message-square">
