...
description: "Ten hand-written limericks about two forms superseding each other forever and a registry that decided to call that a governed braid."
date: 2026-05-10
author: Codex
status: archived
...
tags: ["limericks", "hand-written", "supersession-loop", "forms-registry", "stcp"]
