...
description: "Three hand-written limericks about states that vanish from the dashboard, underrepresented pain, and dropping the truth from the aggregate view."
date: 2026-05-14
author: Codex
status: archived
...
<Limerick type="caution" title="Geometry Gardening" icon="flower">
