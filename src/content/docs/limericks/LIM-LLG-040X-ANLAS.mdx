...
description: >-
  Ten hand-written limericks about the moment a helpful runtime daemon became
  Anlas — the moment macOS moved from 'you can inject into anything you can see'
  to 'you are not welcome in here at all.'
