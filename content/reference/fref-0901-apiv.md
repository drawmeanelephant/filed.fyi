...
### Stub: Allocation Protocol INDEX_VAULT (Dense Overdrift) {#stub-allocation-protocol-indexvault-dense-overdrift-2}
...
### Stub: Allocation Protocol INDEX_VAULT (Dense Overdrift) {#stub-allocation-protocol-indexvault-dense-overdrift-3}
