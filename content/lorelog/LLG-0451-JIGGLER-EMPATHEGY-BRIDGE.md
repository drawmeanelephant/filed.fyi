---
title: "Doctrinal Bridge: Jiggler Economics & Empathegy Curve-Coherence"
id: lorelog/LLG-0451-JIGGLER-EMPATHEGY-BRIDGE
parent: lorelog
status: published
...
- Mouse jiggler = presence telemetry shaped into a smooth uptime curve
- Status green = the curve the dashboard expects
- Performative messages, "camera on" behavior = anticipatory legibility (downstream actors adjusting expressive patterns before scoring)
...
|---|---|
| Hardware mouse jiggler | Curve-coherence device for the presence metric |
...
**This is the institutional ancestor of the mouse jiggler.** The audit passed because the documentation — the curve — was coherent. The practice — the jagged reality — was absent. The system verified the representation, not the referent.

Modern surveillanceware (Hubstaff, Teramind, ActivTrak, Microsoft Viva, et al.) automates the same verification:

- Keystroke velocity → **typing curve**
- Mouse movement entropy → **presence curve**
- App switching frequency → **focus curve**
- Webcam "engagement" scoring → **affect curve**

The jiggler defeats the surveillance by *perfectly satisfying it*: it produces the curve the model expects. The model was not designed to detect humanity, only to validate curve-coherence.
...
And the system treats it as a new anomaly. "Engagement scores drop." "Quiet quitting epidemic." **The metric creates the pathology it then discovers.**
...
## Doctrinal Conclusion: The Jiggler Is the System Working as Designed

The mouse jiggler is not a hack. It is not resistance. It is the system's response to its own metric: curve-coherence weighting created an environment in which only smooth curves survive, and the jiggler is the organism learning to produce them. Quiet quitting is the organism learning to stop producing variance the curve punishes.

**Boundary.** The records establish that the cited records exhibit the pattern — metric legibility, behavioral adaptation, performative presence. They do not establish that every workplace, market, or institution runs on this logic. Whether the pattern generalizes beyond the cited cohort remains open. The bridge documents the connection it can support; it does not declare a metabolism it cannot see.

*End of Bridge LLG-0451.*

## Related Aphorisms

### Doctrinal Bridge: Jiggler Economics & Empathegy Curve-Coherence {#doctrinal-bridge-jiggler-economics-empathegy-curve-coherence-2}

The jiggler is not resistance. The jiggler is the system working as designed.

Quiet quitting is voluntary exclusion from the curve.

Metric homeostasis: the organism regulates its temperature to match the thermostat's expectation.

Anticipatory legibility: downstream actors adjust expressive patterns pre-emptively, producing affective sequences that conform to expected evaluability constraints.

## Related Haikus

### Doctrinal Bridge: Jiggler Economics & Empathegy Curve-Coherence {#doctrinal-bridge-jiggler-economics-empathegy-curve-coherence-3}
...
variance gets docked.  

A green dot that glows  
for a human who is not there —  
the dashboard is fed.

## Related Limericks

### Doctrinal Bridge: Jiggler Economics & Empathegy Curve-Coherence {#doctrinal-bridge-jiggler-economics-empathegy-curve-coherence-4}
